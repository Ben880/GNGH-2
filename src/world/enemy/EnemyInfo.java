...
public class EnemyInfo
{
    ...
    private static int[][] type = new int[20][20];
    private static String[][] stype = new String[20][20];
    private static int[][] amount = new int[20][20];
    private static int[][] skill = new int[20][20];
